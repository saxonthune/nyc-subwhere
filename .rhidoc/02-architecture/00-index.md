...
Topics: architecture, backend, build-time, cache, cloudflare, data-source, dead-reckoning, dev-tooling, fetch-loop, frontend, geometry, gtfs, interpolation, maplibre, motion, mta, overview, position, prediction, realtime, rendering, research, script, threejs, typescript, vite, worker
