...
export const transit_realtime = $root.transit_realtime = (() => {
    ...
    transit_realtime.FeedHeader = (function() {
         ...
         * @property {NyctFeedHeader.$Properties|null} [".nyctFeedHeader"] FeedHeader .nyctFeedHeader
         * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
         */
        ...
        FeedHeader.encode = function (message, writer, _depth) {
            ...
            if (message[".nyctFeedHeader"] != null && $Object.hasOwnProperty.call(message, ".nyctFeedHeader"))
                $root.NyctFeedHeader.encode(message[".nyctFeedHeader"], writer.uint32(/* id 1001, wireType 2 =*/8010).fork(), _depth + 1).ldelim();
            if (message.$unknowns != null && $Object.hasOwnProperty.call(message, "$unknowns"))
                for (let i = 0; i < message.$unknowns.length; ++i)
                    writer.raw(message.$unknowns[i]);
            return writer;
        ...
        FeedHeader.decode = function (reader, length, _end, _depth, _target) {
            ...
            while (reader.pos < end) {
                ...
                case 1001: {
                        if (wireType !== 2)
                            break;
                        message[".nyctFeedHeader"] = $root.NyctFeedHeader.decode(reader, reader.uint32(), $undefined, _depth + 1, message[".nyctFeedHeader"]);
                        continue;
                    }
                }
                reader.skipType(wireType, _depth, tag);
        ...
        FeedHeader.verify = function (message, _depth) {
            ...
            if (message[".nyctFeedHeader"] != null && $Object.hasOwnProperty.call(message, ".nyctFeedHeader")) {
                let error = $root.NyctFeedHeader.verify(message[".nyctFeedHeader"], _depth + 1);
                if (error)
        ...
        FeedHeader.fromObject = function (object, _depth) {
            ...
            if (object[".nyctFeedHeader"] != null) {
                if (!$util.isObject(object[".nyctFeedHeader"]))
                    throw $TypeError(".transit_realtime.FeedHeader..nyctFeedHeader: object expected");
                message[".nyctFeedHeader"] = $root.NyctFeedHeader.fromObject(object[".nyctFeedHeader"], _depth + 1);
            }
            return message;
        };
        ...
        FeedHeader.toObject = function (message, options, _depth) {
            ...
            if (message[".nyctFeedHeader"] != null && $Object.hasOwnProperty.call(message, ".nyctFeedHeader"))
                object[".nyctFeedHeader"] = $root.NyctFeedHeader.toObject(message[".nyctFeedHeader"], options, _depth + 1);
            return object;
        };
    ...
    transit_realtime.TripUpdate = (function() {
        ...
        TripUpdate.StopTimeUpdate = (function() {
             ...
             * @property {NyctStopTimeUpdate.$Properties|null} [".nyctStopTimeUpdate"] StopTimeUpdate .nyctStopTimeUpdate
             * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
             */
            ...
            StopTimeUpdate.encode = function (message, writer, _depth) {
                ...
                if (message[".nyctStopTimeUpdate"] != null && $Object.hasOwnProperty.call(message, ".nyctStopTimeUpdate"))
                    $root.NyctStopTimeUpdate.encode(message[".nyctStopTimeUpdate"], writer.uint32(/* id 1001, wireType 2 =*/8010).fork(), _depth + 1).ldelim();
                if (message.$unknowns != null && $Object.hasOwnProperty.call(message, "$unknowns"))
                    for (let i = 0; i < message.$unknowns.length; ++i)
                        writer.raw(message.$unknowns[i]);
                return writer;
            ...
            StopTimeUpdate.decode = function (reader, length, _end, _depth, _target) {
                ...
                while (reader.pos < end) {
                    ...
                    case 1001: {
                            if (wireType !== 2)
                                break;
                            message[".nyctStopTimeUpdate"] = $root.NyctStopTimeUpdate.decode(reader, reader.uint32(), $undefined, _depth + 1, message[".nyctStopTimeUpdate"]);
                            continue;
                        }
                    }
                    reader.skipType(wireType, _depth, tag);
            ...
            StopTimeUpdate.verify = function (message, _depth) {
                ...
                if (message[".nyctStopTimeUpdate"] != null && $Object.hasOwnProperty.call(message, ".nyctStopTimeUpdate")) {
                    let error = $root.NyctStopTimeUpdate.verify(message[".nyctStopTimeUpdate"], _depth + 1);
                    if (error)
            ...
            StopTimeUpdate.fromObject = function (object, _depth) {
                ...
                if (object[".nyctStopTimeUpdate"] != null) {
                    if (!$util.isObject(object[".nyctStopTimeUpdate"]))
                        throw $TypeError(".transit_realtime.TripUpdate.StopTimeUpdate..nyctStopTimeUpdate: object expected");
                    message[".nyctStopTimeUpdate"] = $root.NyctStopTimeUpdate.fromObject(object[".nyctStopTimeUpdate"], _depth + 1);
                }
                return message;
            };
            ...
            StopTimeUpdate.toObject = function (message, options, _depth) {
                ...
                if (message[".nyctStopTimeUpdate"] != null && $Object.hasOwnProperty.call(message, ".nyctStopTimeUpdate"))
                    object[".nyctStopTimeUpdate"] = $root.NyctStopTimeUpdate.toObject(message[".nyctStopTimeUpdate"], options, _depth + 1);
                return object;
            };
    ...
    transit_realtime.Alert = (function() {
        ...
        Alert.verify = function (message, _depth) {
            ...
            if (message.communicationPeriod != null && $Object.hasOwnProperty.call(message, "communicationPeriod")) {
                if (!$Array.isArray(message.communicationPeriod))
                    return "communicationPeriod: array expected";
                for (let i = 0; i < message.communicationPeriod.length; ++i) {
                    let error = $root.transit_realtime.TimeRange.verify(message.communicationPeriod[i], _depth + 1);
                    if (error)
                        return "communicationPeriod." + error;
                }
            }
            if (message.impactPeriod != null && $Object.hasOwnProperty.call(message, "impactPeriod")) {
                if (!$Array.isArray(message.impactPeriod))
                    return "impactPeriod: array expected";
                for (let i = 0; i < message.impactPeriod.length; ++i) {
                    let error = $root.transit_realtime.TimeRange.verify(message.impactPeriod[i], _depth + 1);
                    if (error)
        ...
        Alert.fromObject = function (object, _depth) {
            ...
            if (object.communicationPeriod) {
                ...
                for (let i = 0; i < object.communicationPeriod.length; ++i) {
                    if (!$util.isObject(object.communicationPeriod[i]))
            ...
            if (object.impactPeriod) {
                ...
                for (let i = 0; i < object.impactPeriod.length; ++i) {
                    if (!$util.isObject(object.impactPeriod[i]))
        ...
        Alert.toObject = function (message, options, _depth) {
            ...
            if (message.communicationPeriod && message.communicationPeriod.length) {
                ...
                for (let j = 0; j < message.communicationPeriod.length; ++j)
                    object.communicationPeriod[j] = $root.transit_realtime.TimeRange.toObject(message.communicationPeriod[j], options, _depth + 1);
            }
            if (message.impactPeriod && message.impactPeriod.length) {
                object.impactPeriod = $Array(message.impactPeriod.length);
                for (let j = 0; j < message.impactPeriod.length; ++j)
                    object.impactPeriod[j] = $root.transit_realtime.TimeRange.toObject(message.impactPeriod[j], options, _depth + 1);
            }
            if (message.informedEntity && message.informedEntity.length) {
    ...
    transit_realtime.TripDescriptor = (function() {
         ...
         * @property {NyctTripDescriptor.$Properties|null} [".nyctTripDescriptor"] TripDescriptor .nyctTripDescriptor
         * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
         */
        ...
        TripDescriptor.encode = function (message, writer, _depth) {
            ...
            if (message[".nyctTripDescriptor"] != null && $Object.hasOwnProperty.call(message, ".nyctTripDescriptor"))
                $root.NyctTripDescriptor.encode(message[".nyctTripDescriptor"], writer.uint32(/* id 1001, wireType 2 =*/8010).fork(), _depth + 1).ldelim();
            if (message.$unknowns != null && $Object.hasOwnProperty.call(message, "$unknowns"))
                for (let i = 0; i < message.$unknowns.length; ++i)
                    writer.raw(message.$unknowns[i]);
            return writer;
        ...
        TripDescriptor.decode = function (reader, length, _end, _depth, _target) {
            ...
            while (reader.pos < end) {
                ...
                case 1001: {
                        if (wireType !== 2)
                            break;
                        message[".nyctTripDescriptor"] = $root.NyctTripDescriptor.decode(reader, reader.uint32(), $undefined, _depth + 1, message[".nyctTripDescriptor"]);
                        continue;
                    }
                }
                reader.skipType(wireType, _depth, tag);
        ...
        TripDescriptor.verify = function (message, _depth) {
            ...
            if (message[".nyctTripDescriptor"] != null && $Object.hasOwnProperty.call(message, ".nyctTripDescriptor")) {
                let error = $root.NyctTripDescriptor.verify(message[".nyctTripDescriptor"], _depth + 1);
                if (error)
        ...
        TripDescriptor.fromObject = function (object, _depth) {
            ...
            if (object[".nyctTripDescriptor"] != null) {
                if (!$util.isObject(object[".nyctTripDescriptor"]))
                    throw $TypeError(".transit_realtime.TripDescriptor..nyctTripDescriptor: object expected");
                message[".nyctTripDescriptor"] = $root.NyctTripDescriptor.fromObject(object[".nyctTripDescriptor"], _depth + 1);
            }
            return message;
        };
        ...
        TripDescriptor.toObject = function (message, options, _depth) {
            ...
            if (message[".nyctTripDescriptor"] != null && $Object.hasOwnProperty.call(message, ".nyctTripDescriptor"))
                object[".nyctTripDescriptor"] = $root.NyctTripDescriptor.toObject(message[".nyctTripDescriptor"], options, _depth + 1);
            return object;
        };
...
export const TripReplacementPeriod = $root.TripReplacementPeriod = (() => {

    /**
     * Properties of a TripReplacementPeriod.
     * @typedef {Object} TripReplacementPeriod.$Properties
     ...
     * @augments TripReplacementPeriod.$Properties
     * @deprecated Use TripReplacementPeriod.$Properties instead.
     */

    /**
     * Shape of a TripReplacementPeriod.
     * @typedef {TripReplacementPeriod.$Properties} TripReplacementPeriod.$Shape
     */
     ...
     * @constructor
     * @param {TripReplacementPeriod.$Properties=} [properties] Properties to set
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
     ...
     * @type {{
     *   (properties: TripReplacementPeriod.$Shape): TripReplacementPeriod & TripReplacementPeriod.$Shape;
     *   (properties?: TripReplacementPeriod.$Properties): TripReplacementPeriod;
     * }}
     */
     ...
     * @memberof TripReplacementPeriod
     * @static
     * @param {TripReplacementPeriod.$Properties} message TripReplacementPeriod message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {TripReplacementPeriod & TripReplacementPeriod.$Shape} TripReplacementPeriod
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    TripReplacementPeriod.decode = function (reader, length, _end, _depth, _target) {
        ...
        if (_depth > $Reader.recursionLimit)
            throw $Error("max depth exceeded");
        let end = length === $undefined ? reader.len : reader.pos + length, message = _target || new $root.TripReplacementPeriod();
        while (reader.pos < end) {
            let start = reader.pos;
            let tag = reader.tag();
            if (tag === _end) {
    ...
    TripReplacementPeriod.fromObject = function (object, _depth) {
        if (object instanceof $root.TripReplacementPeriod)
            return object;
        if (!$util.isObject(object))
            throw $TypeError(".TripReplacementPeriod: object expected");
        if (_depth === $undefined)
            _depth = 0;
        if (_depth > $util.recursionLimit)
            throw $Error("max depth exceeded");
        let message = new $root.TripReplacementPeriod();
        if (object.routeId != null)
            message.routeId = $String(object.routeId);
    ...
    TripReplacementPeriod.getTypeUrl = function(prefix) {
        if (prefix === $undefined)
            prefix = "type.googleapis.com";
        return prefix + "/TripReplacementPeriod";
    };

    return TripReplacementPeriod;
})();

export const NyctFeedHeader = $root.NyctFeedHeader = (() => {

    /**
     * Properties of a NyctFeedHeader.
     * @typedef {Object} NyctFeedHeader.$Properties
     * @property {string} nyctSubwayVersion NyctFeedHeader nyctSubwayVersion
     * @property {Array.<TripReplacementPeriod.$Properties>|null} [tripReplacementPeriod] NyctFeedHeader tripReplacementPeriod
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
     ...
     * @augments NyctFeedHeader.$Properties
     * @deprecated Use NyctFeedHeader.$Properties instead.
     */

    /**
     * Shape of a NyctFeedHeader.
     * @typedef {NyctFeedHeader.$Properties} NyctFeedHeader.$Shape
     */
     ...
     * @constructor
     * @param {NyctFeedHeader.$Properties=} [properties] Properties to set
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
     ...
     * @member {Array.<TripReplacementPeriod.$Properties>} tripReplacementPeriod
     * @memberof NyctFeedHeader
     * @instance
     */
     ...
     * @type {{
     *   (properties: NyctFeedHeader.$Shape): NyctFeedHeader & NyctFeedHeader.$Shape;
     *   (properties?: NyctFeedHeader.$Properties): NyctFeedHeader;
     * }}
     */
     ...
     * @memberof NyctFeedHeader
     * @static
     * @param {NyctFeedHeader.$Properties} message NyctFeedHeader message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    NyctFeedHeader.encode = function (message, writer, _depth) {
        ...
        if (message.tripReplacementPeriod != null && message.tripReplacementPeriod.length)
            for (let i = 0; i < message.tripReplacementPeriod.length; ++i)
                $root.TripReplacementPeriod.encode(message.tripReplacementPeriod[i], writer.uint32(/* id 2, wireType 2 =*/18).fork(), _depth + 1).ldelim();
        if (message.$unknowns != null && $Object.hasOwnProperty.call(message, "$unknowns"))
            for (let i = 0; i < message.$unknowns.length; ++i)
                writer.raw(message.$unknowns[i]);
        return writer;
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {NyctFeedHeader & NyctFeedHeader.$Shape} NyctFeedHeader
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    NyctFeedHeader.decode = function (reader, length, _end, _depth, _target) {
        ...
        if (_depth > $Reader.recursionLimit)
            throw $Error("max depth exceeded");
        let end = length === $undefined ? reader.len : reader.pos + length, message = _target || new $root.NyctFeedHeader();
        while (reader.pos < end) {
            let start = reader.pos;
            let tag = reader.tag();
            if (tag === _end) {
            ...
            case 2: {
                    ...
                    message.tripReplacementPeriod.push($root.TripReplacementPeriod.decode(reader, reader.uint32(), $undefined, _depth + 1));
                    continue;
                }
            }
            reader.skipType(wireType, _depth, tag);
    ...
    NyctFeedHeader.verify = function (message, _depth) {
        ...
        if (message.tripReplacementPeriod != null && $Object.hasOwnProperty.call(message, "tripReplacementPeriod")) {
            ...
            for (let i = 0; i < message.tripReplacementPeriod.length; ++i) {
                let error = $root.TripReplacementPeriod.verify(message.tripReplacementPeriod[i], _depth + 1);
                if (error)
    ...
    NyctFeedHeader.fromObject = function (object, _depth) {
        if (object instanceof $root.NyctFeedHeader)
            return object;
        if (!$util.isObject(object))
            throw $TypeError(".NyctFeedHeader: object expected");
        if (_depth === $undefined)
            _depth = 0;
        if (_depth > $util.recursionLimit)
            throw $Error("max depth exceeded");
        let message = new $root.NyctFeedHeader();
        ...
        if (object.tripReplacementPeriod) {
            ...
            for (let i = 0; i < object.tripReplacementPeriod.length; ++i) {
                ...
                message.tripReplacementPeriod[i] = $root.TripReplacementPeriod.fromObject(object.tripReplacementPeriod[i], _depth + 1);
            }
        }
        return message;
    };
    ...
    NyctFeedHeader.toObject = function (message, options, _depth) {
        ...
        if (message.tripReplacementPeriod && message.tripReplacementPeriod.length) {
            ...
            for (let j = 0; j < message.tripReplacementPeriod.length; ++j)
                object.tripReplacementPeriod[j] = $root.TripReplacementPeriod.toObject(message.tripReplacementPeriod[j], options, _depth + 1);
        }
        return object;
    };
    ...
    NyctFeedHeader.getTypeUrl = function(prefix) {
        if (prefix === $undefined)
            prefix = "type.googleapis.com";
        return prefix + "/NyctFeedHeader";
    };

    return NyctFeedHeader;
})();

export const NyctTripDescriptor = $root.NyctTripDescriptor = (() => {

    /**
     * Properties of a NyctTripDescriptor.
     * @typedef {Object} NyctTripDescriptor.$Properties
     ...
     * @augments NyctTripDescriptor.$Properties
     * @deprecated Use NyctTripDescriptor.$Properties instead.
     */

    /**
     * Shape of a NyctTripDescriptor.
     * @typedef {NyctTripDescriptor.$Properties} NyctTripDescriptor.$Shape
     */
     ...
     * @constructor
     * @param {NyctTripDescriptor.$Properties=} [properties] Properties to set
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
     ...
     * @type {{
     *   (properties: NyctTripDescriptor.$Shape): NyctTripDescriptor & NyctTripDescriptor.$Shape;
     *   (properties?: NyctTripDescriptor.$Properties): NyctTripDescriptor;
     * }}
     */
     ...
     * @memberof NyctTripDescriptor
     * @static
     * @param {NyctTripDescriptor.$Properties} message NyctTripDescriptor message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {NyctTripDescriptor & NyctTripDescriptor.$Shape} NyctTripDescriptor
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    NyctTripDescriptor.decode = function (reader, length, _end, _depth, _target) {
        ...
        if (_depth > $Reader.recursionLimit)
            throw $Error("max depth exceeded");
        let end = length === $undefined ? reader.len : reader.pos + length, message = _target || new $root.NyctTripDescriptor(), value;
        while (reader.pos < end) {
            let start = reader.pos;
            let tag = reader.tag();
            if (tag === _end) {
            ...
            case 3: {
                    if (wireType !== 0)
                        break;
                    value = reader.int32();
                    if ($root.NyctTripDescriptor.Direction[value] !== $undefined)
    ...
    NyctTripDescriptor.fromObject = function (object, _depth) {
        if (object instanceof $root.NyctTripDescriptor)
            return object;
        if (!$util.isObject(object))
            throw $TypeError(".NyctTripDescriptor: object expected");
        if (_depth === $undefined)
            _depth = 0;
        if (_depth > $util.recursionLimit)
            throw $Error("max depth exceeded");
        let message = new $root.NyctTripDescriptor();
    ...
    NyctTripDescriptor.getTypeUrl = function(prefix) {
        if (prefix === $undefined)
            prefix = "type.googleapis.com";
        return prefix + "/NyctTripDescriptor";
    };
...
export const NyctStopTimeUpdate = $root.NyctStopTimeUpdate = (() => {

    /**
     * Properties of a NyctStopTimeUpdate.
     * @typedef {Object} NyctStopTimeUpdate.$Properties
     ...
     * @augments NyctStopTimeUpdate.$Properties
     * @deprecated Use NyctStopTimeUpdate.$Properties instead.
     */

    /**
     * Shape of a NyctStopTimeUpdate.
     * @typedef {NyctStopTimeUpdate.$Properties} NyctStopTimeUpdate.$Shape
     */
     ...
     * @constructor
     * @param {NyctStopTimeUpdate.$Properties=} [properties] Properties to set
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
     ...
     * @type {{
     *   (properties: NyctStopTimeUpdate.$Shape): NyctStopTimeUpdate & NyctStopTimeUpdate.$Shape;
     *   (properties?: NyctStopTimeUpdate.$Properties): NyctStopTimeUpdate;
     * }}
     */
     ...
     * @memberof NyctStopTimeUpdate
     * @static
     * @param {NyctStopTimeUpdate.$Properties} message NyctStopTimeUpdate message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {NyctStopTimeUpdate & NyctStopTimeUpdate.$Shape} NyctStopTimeUpdate
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    NyctStopTimeUpdate.decode = function (reader, length, _end, _depth, _target) {
        ...
        if (_depth > $Reader.recursionLimit)
            throw $Error("max depth exceeded");
        let end = length === $undefined ? reader.len : reader.pos + length, message = _target || new $root.NyctStopTimeUpdate();
        while (reader.pos < end) {
            let start = reader.pos;
            let tag = reader.tag();
            if (tag === _end) {
    ...
    NyctStopTimeUpdate.fromObject = function (object, _depth) {
        if (object instanceof $root.NyctStopTimeUpdate)
            return object;
        if (!$util.isObject(object))
            throw $TypeError(".NyctStopTimeUpdate: object expected");
        if (_depth === $undefined)
            _depth = 0;
        if (_depth > $util.recursionLimit)
            throw $Error("max depth exceeded");
        let message = new $root.NyctStopTimeUpdate();
    ...
    NyctStopTimeUpdate.getTypeUrl = function(prefix) {
        if (prefix === $undefined)
            prefix = "type.googleapis.com";
        return prefix + "/NyctStopTimeUpdate";
    };
